# Урок №1 - Задание №1 (Lesson №1 - Task №1)
# Поработайте с переменными, создайте несколько, выведите на экран,
# запросите у пользователя несколько чисел и строк и сохраните в переменные, выведите на экран.
# (Work with variables, create several, display,
# ask the user for several numbers and strings and save them to variables, display.)

# Создаем переменные. В ней храним возраст бота имя
# (Create a variables. We store the bot's age and name in it)

bot_age = int(15) # Возраст бота (bot age)
